// filepath: [eslint.config.mjs](http://_vscodecontentref_/4)
  ...
  ...nx.configs['flat/react'], // Add Nx React-specific rules
  {
    ...
    languageOptions: {
      ...
      parserOptions: {
        ...
        ecmaVersion: 'latest',
        sourceType: 'module',
        project: './tsconfig.app.json', // Use the chat project's tsconfig.app.json
      },
    },
    rules: {
      // Add any chat-specific rules here if needed
    },
  },
];